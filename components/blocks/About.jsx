  ...
  return (
    <section id="about" className="relative">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative min-h-[700px] max-h-[750px]">
          ...
          <div className="absolute top-0 left-0 text-white center items-center lg:px-0 z-[1] h-full">
            <div className="container lg:px-[52px] space-y-[24px]">
              ...
              <div className="flex gap-x-[12px]">
                <Link
                  href={`/`}
                  className="primary-button pointer text-xs lg:text-lg"
                >
                  Learn More
                </Link>
                <Link
                  href={`/`}
                  className="tertiary-button text-black pointer text-xs lg:text-lg"
                >
                  Watch Video
                </Link>
              </div>
